...
public class MainContainer extends Actor
{
    ...
    /**
     * Checks if the container is hovering over a truck
     */
    private void checkHoveringTruck()
    {
        ...
        {            
            ...
            if(truckType == containerType && c.loaded == false)//true when the container hovers over a not loaded truck of the correct type
            {                
    ...
    /**
     * Converts the type to the format used in the class Containergame2
     */
